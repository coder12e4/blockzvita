...
body: Container(
  ...
  child: Column(
    ...
    children: [
      Image.asset("assets/nodatafount.png",height: 100,width: 100,),
      SizedBox(height: 8,),
      Text("NO data found".toUpperCase(),style: TextStyle(fontSize: 24,fontWeight: FontWeight.w400,letterSpacing: 1),)
      ,SizedBox(height: 8,),
