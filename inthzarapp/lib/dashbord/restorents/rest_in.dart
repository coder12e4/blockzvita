...
class rest_in extends StatefulWidget {
  rest_in({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _rest_inState createState() => _rest_inState();
}
...
class _rest_inState extends State<rest_in> {
  ...
  final key = new GlobalKey<_rest_inState>();
            ...
            child: SingleChildScrollView(
              child: Container(
                child: Column(children: [
                  Container(width: double.infinity,height: 450,child: Container(
                    height: 440,
                    child: Stack(
                      children: [
                        Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            //   color: Colors.grey,
                                            // ),
                                            Image.asset("outline_call.png",height: 18,color: HexColor("DADADA")),
                                            Text(
                                              "CALL NOW",
                                              style: TextStyle(
                                                  fontSize: 12,
                                    ...
                                    Expanded(
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          CrossAxisAlignment.center,
                                          children: [
                                            Image.asset("outline_location.png",height: 18,color: HexColor("DADADA")),
                                            Text(
                                              "DIRECTION",
                                              style: TextStyle(
                                                  fontSize: 12,
                                        ...
                                        child: GestureDetector(
                                          ...
                                          child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                CrossAxisAlignment.center,
                                                children: [
                                                  Image.asset("reply.png",height: 18,color: Colors.black,fit: BoxFit.fitWidth,),
                                                   // Icon(
                                                   //   Icons.,
                                                   //   size: 18,
                                                   //   color: Colors.grey,
                                ...
                                Row(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.center,
                                  children: [
                                    Image.asset("assets/whats.png",height: 37,),
                                    SizedBox(
                                      width: 20,
                                    ),
                                    Image.asset("assets/fac.png",height: 37,),
                                    SizedBox(
                                      width: 20,
                                    ),
                                    Image.asset("assets/insta.png",height: 37,),
                                    SizedBox(
                                      width: 20,
                                    ),
                                    Image.asset("assets/link.png",height: 37,),
                                    SizedBox(
                                      width: 20,
                                    )
                                  ],
            ...
            children: [
              ...
              new Container(
                ...
                child: Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Image.asset("outline_call.png",height: 20,color: HexColor("DADADA")),
                    SizedBox(
                      width: 15,
                    ),
                    Expanded(
