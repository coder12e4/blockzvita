...
import 'package:inthzarapp/dashbord/jobs/enquiry_page.dart';
                                    ...
                                    Expanded(
                                        child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text("Electrician 1",style: TextStyle(
                                                  fontWeight: FontWeight.w400,
                                                  letterSpacing: 1,
                                                  fontSize: 15,
                                      ...
                                      child: GestureDetector(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(
                                            ...
                                            CrossAxisAlignment.center,
                                            children: [
                                              Icon(Icons.location_on,size: 17,color: HexColor("DADADA"),),
                                              Padding(
                                                  padding: EdgeInsets.only(left: 4),
