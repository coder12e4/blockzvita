...
class freelanceregister extends StatefulWidget {
  freelanceregister({Key key, this.title}) : super(key: key);
  ...
  @override
  _freelanceregisterState createState() => _freelanceregisterState();
}

class _freelanceregisterState extends State<freelanceregister> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Register as a Freelancer".toUpperCase(),style: TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.w400),),
      ),
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
              SizedBox(height: 18,),
              Text("List your bussiness",style: TextStyle(fontSize: 20,color: HexColor("C97F08")),),
              SizedBox(height: 7,),
...
onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (BuildContext)=>add_freelance_inn()));
},
            ),)
