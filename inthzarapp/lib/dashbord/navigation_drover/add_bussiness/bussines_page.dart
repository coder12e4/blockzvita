...
import 'add_bussines_inner.dart';


class add_bussiness extends StatefulWidget {
  add_bussiness({Key key, this.title}) : super(key: key);
  ...
  @override
  _add_bussinessState createState() => _add_bussinessState();
}

class _add_bussinessState extends State<add_bussiness> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("ADD BUSINESS",style: TextStyle(fontSize: 16,color: Colors.black,fontWeight: FontWeight.w400,letterSpacing: .5),),
      ),
          ...
          children: [
            Container(
              ...
              child: Column(
                ...
                children: [
              SizedBox(height: 18,),
              Text("List your business",style: TextStyle(fontSize: 20,color: HexColor("C97F08")),),
              SizedBox(height: 7,),
...
onPressed: (){
                Navigator.push(context, MaterialPageRoute(builder: (BuildContext)=>add_bussiness_()));
},
            ),),
            SizedBox(height: 90,),
          ],),),
